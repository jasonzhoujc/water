...
<div class="block clearfix">
 <?php echo $this->fetch('library/ur_here.lbi'); ?>
	  <h1 class="mod2Tit"><?php echo $this->_var['lang']['shipping_method']; ?></h1>
...
?>
		...
		<form action="myship.php" method="post" name="theForm" id="theForm" onsubmit="return checkForm(this)" class="blank">
