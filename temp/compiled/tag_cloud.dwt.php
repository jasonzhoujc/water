...
<div class="block modbox clearfix">
  <h1 class="modTit blank"><?php echo $this->_var['lang']['all_tags']; ?></h1>
	<div class="mod2con">
...
?>
          ...
          <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>&amp;uid=<?php echo $this->_var['tag']['user_id']; ?>" title="<?php echo $this->_var['lang']['drop']; ?>"> <img src="themes/3cShop/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /> </a>&nbsp;&nbsp;
          <?php endif; ?>
          </span>
