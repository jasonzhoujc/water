...
?>
            <div class="goodsbox">
             ...
             <div class="helpList tl">
                <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_74739100_1384612760');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_74739100_1384612760']):
?>
                ·<a href="<?php echo $this->_var['item_0_74739100_1384612760']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item_0_74739100_1384612760']['title']); ?>"><?php echo $this->_var['item_0_74739100_1384612760']['short_title']; ?></a><br />
         ...
         <div class="share">
            ...
            <script type="text/javascript">
                bShareOpt = {
                   uuid: "", 
                   url: "", //商品的永久链接
                   summary: "<?php echo $this->_var['goods_info']['goods_brief']; ?>", //商品描述
                   pic: "./../<?php echo $this->_var['goods_info']['goods_img']; ?>", //商品图片链接
                   vUid: "$_SESSION['user_id']|$_SESSION['user_name']", //用户id，为了让您能够知道您网站的注册用户分享、喜欢了哪些商品
                   product: "<?php echo $this->_var['goods_info']['goods_name']; ?>", //商品名称
                   price: "<?php echo $this->_var['goods_info']['promote_price']; ?>", //商品价格
                   brand: "<?php echo $this->_var['brand_name']; ?>", //商品品牌
