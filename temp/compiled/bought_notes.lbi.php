...
<div class="mod2Tit"><?php echo $this->_var['lang']['bought_notes']; ?>(<?php echo $this->_var['lang']['later_bought_amounts']; ?><font class=""><?php echo $this->_var['pager']['record_count']; ?></font>)</div>
<div class="clearfix blank">
 <?php if ($this->_var['notes']): ?>
  <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#ccc" class="blank">
       <tr>
			 <th width="25%" align="center" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['username']; ?></th>
			 <th width="10%" align="center" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['number']; ?></th>
			 <th width="45%" align="center" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['bought_time']; ?></th>
			 <th width="20%" align="center" bgcolor="#FFFFFF"><?php echo $this->_var['lang']['order_status']; ?></th>
			 </tr>
...
?>
       <tr>
			 ...
			 <?php if ($this->_var['note']['user_name']): ?><?php echo htmlspecialchars($this->_var['note']['user_name']); ?><?php else: ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?>			 </td>
			 <td align="center" bgcolor="#FFFFFF">
			 <?php echo $this->_var['note']['goods_number']; ?>			 </td>
			 <td align="center" bgcolor="#FFFFFF">
			 <?php echo $this->_var['note']['add_time']; ?>			 </td>
			 <td align="center" bgcolor="#FFFFFF">
			 <?php if ($this->_var['note']['order_status']): ?><?php echo $this->_var['lang']['turnover']; ?><?php else: ?><?php echo $this->_var['lang']['is_cancel']; ?><?php endif; ?>			 </td>
			 </tr>
       <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
</table>
 <?php else: ?>
     <div class="tips"><?php echo $this->_var['lang']['no_notes']; ?></div>
 <?php endif; ?>
