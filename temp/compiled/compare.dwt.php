...
<?php echo $this->fetch('library/ur_here.lbi'); ?>
 <div class="compare"><img src="themes/3cShop/images/compare.jpg"/></div>
...
if ($this->_foreach['goods_list']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['goods_list']['iteration']++;
?>
                <td bgcolor="#ffffff">&nbsp;&nbsp;<span class="goods-price"><img src="themes/3cShop/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" width="64" height="12" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" /></span><br /></td>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </tr>
              <tr>
