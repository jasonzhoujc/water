...
?>
        ...
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </select> <input type="submit" name="Submit" class="bnt_number10"  value="<?php echo $this->_var['lang']['search_ship']; ?>" />
...
<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
  <tr>
    ...
    <th width="60%" bgcolor="#ffffff"><?php echo $this->_var['lang']['describe']; ?></th>
    <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['fee']; ?></th>
    <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['insure_fee']; ?></th>
  </tr>
