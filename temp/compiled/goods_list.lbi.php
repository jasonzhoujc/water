<div class="mod2Tit clearfix blank">
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')"><img src="themes/3cShop/images/display_mode_text<?php if ($this->_var['pager']['display'] == 'text'): ?>_act<?php endif; ?>.gif" alt="<?php echo $this->_var['lang']['display']['text']; ?>"></a>&nbsp;&nbsp;<font style="font-weight:100; font-size:12px;">排序方式：</font>
...
?>
    ...
    <li class="action">
        <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)">购买</a> | 
        <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)">收藏</a> |  
        <a href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')">比较</a>
    </li>
    </ul>
     ...
     <div class="goodsbox">
           <div class="imgbox">
            ...
            <div class="buy_action">
                <a class="baby_buy" href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)">
                    <img src="themes/3cShop/images/baby_buy.jpg">
                </a>
                <a class="baby_collection" href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>)">
                    <img src="themes/3cShop/images/baby_collection.jpg">
                </a>
                <a class="baby_compare" href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')">
