...
?>
			...
			<!-- <?php echo $this->_var['lang']['goods_sn']; ?><?php echo $this->_var['goods']['goods_sn']; ?><br /> -->
			<?php endif; ?>
			
			<?php if ($this->_var['goods']['goods_number'] != "" && $this->_var['cfg']['show_goodsnumber']): ?>
			<?php if ($this->_var['goods']['goods_number'] == 0): ?>
			<?php echo $this->_var['lang']['goods_number']; ?><img src="themes/3cShop/images/wuhuo.gif" /><br />
			<?php else: ?>
			<?php echo $this->_var['lang']['goods_number']; ?> <?php echo $this->_var['goods']['goods_number']; ?> <?php echo $this->_var['goods']['measure_unit']; ?><br />
			<?php endif; ?>
			<?php endif; ?>
			
			<?php if ($this->_var['goods']['goods_brand'] != "" && $this->_var['cfg']['show_brand']): ?>
			<?php echo $this->_var['lang']['goods_brand']; ?><a href="<?php echo $this->_var['goods']['goods_brand_url']; ?>" ><u><?php echo $this->_var['goods']['goods_brand']; ?></u></a><br />
			<?php endif; ?>
			...
			<!-- <?php echo $this->_var['lang']['add_time']; ?><?php echo $this->_var['goods']['add_time']; ?><br /> -->
			<?php endif; ?>
			
			
			<!-- <?php echo $this->_var['lang']['goods_click_count']; ?>：<?php echo $this->_var['goods']['click_count']; ?><br /> -->
			<!-- <?php echo $this->_var['lang']['goods_rank']; ?> <img src="themes/3cShop/images/stars<?php echo $this->_var['goods']['comment_rank']; ?>.gif" alt="comment rank <?php echo $this->_var['goods']['comment_rank']; ?>" /><br /> -->
 ...
 <div id="attribuet" class="attribuet fl">
   <div class="tagTit" id="com_b">
	  <h2><span class="L"></span><span class="R"></span><?php echo $this->_var['lang']['feed_goods_desc']; ?></h2>
		...
		<h2 class="h2bg"><span class="L"></span><span class="R"></span><?php echo $this->_var['lang']['goods_tag']; ?></h2>
		<?php if ($this->_var['package_goods_list']): ?>
		<h2 class="h2bg"><span class="L"></span><span class="R"></span><font id="package"><?php echo $this->_var['lang']['remark_package']; ?></font></h2>
